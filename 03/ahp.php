...
<div class="jumbotron text-center">
  ...
  <p>Analytical Hierarchy Process (AHP)</p> 
</div>
...
<button type="button" class="btn btn-primary btn-block">Home</button>
  ...
  <div class="row">
      <h3 class="text-center">Alternatif Pasar</h3>
      <?php
        // Atlanta
        $a1c11 = 1;
        $a1c12 = 4;
      ...
      <h3 class="text-center">Alternatif Pendapatan</h3>
      <?php
        // Atlanta
        $a2c11 = 1;
        $a2c12 = 1 / 6;
      ...
      <h3 class="text-center">Alternatif Infrastruktur</h3>
      <?php
        // Atlanta
        $a3c11 = 1;
        $a3c12 = 1 / 3;
      ...
      <h3 class="text-center">Alternatif Transportasi</h3>
      <?php
        // Atlanta
        $a4c11 = 1;
        $a4c12 = 1 / 2;
      ...
      <h3 class="text-center">Pengambilan Keputusan</h3>
      <?php
        ...
        if ($pk2 > $pk3) {
            ...
            echo ("<h4><b>terpilih adalah Alternatif 2 yaitu Birmingham</b></h4>");
        } else {

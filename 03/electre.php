...
<div class="jumbotron text-center">
  ...
  <p>Elimination Et Choix. Traduisant La Realite (Electre)</p> 
</div>
...
<button type="button" class="btn btn-primary btn-block">Home</button>
  ...
  <div class="row">
    ...
    <h3 class="text-center"><b>yang terpilih adalah Apartemen 2 dan Apartemen 3</b></h3>   
  </div>
</div>
</body>
</html>